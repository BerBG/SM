...
import tutorImg from "../../assets/images/tutor-img02.png";
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              <figure className="max-w-[200px] max-h-[200px]">
                <img src={tutorImg} alt="" className="w-full rounded-lg" />
              </figure>
              ...
              leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded"
                ...
                <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                  Muhibur Rahman is an experienced web developer with extensive
